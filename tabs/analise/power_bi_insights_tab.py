...
class PowerBIInsightsTab(TabInterface):
    ...
    def render(self):
        with self.tab:
            ...
            st.markdown(
                """
                Durante a faixa histórica analisada, pudemos associar eventos geopolíticos aos picos de aumento e queda nos preços registrados. Conforme destacamos à seguir:\n
